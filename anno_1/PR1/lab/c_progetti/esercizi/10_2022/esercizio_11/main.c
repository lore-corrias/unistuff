 ...
 * inserito con scanf() e stampare il seguente messaggio in output: Importo in sterline pari a ____.__ GBP.
...
// entry point
int main() {
    // dichiarazione della variabile importoEuro
    float importoEuro;

    // lettura della variabile in input
    printf("Inserisci il valore da convertire da euro a sterlina: ");
    scanf("%f", &importoEuro);
